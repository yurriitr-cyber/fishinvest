...
const FISH_SEED: Array<{
  ...
  { symbol: 'GLDFSH', name: 'Glitch Goldfish', rarity: FishRarity.COMMON, price: 0.017, supply: 50_000_000, volatility: 0.42, trend: 0.002 },
  { symbol: 'NEON', name: 'Neon Tetra', rarity: FishRarity.COMMON, price: 0.034, supply: 40_000_000, volatility: 0.4, trend: 0.003 },
  { symbol: 'CATFSH', name: 'Abyss Catfish', rarity: FishRarity.COMMON, price: 0.085, supply: 25_000_000, volatility: 0.36, trend: 0.004 },
  { symbol: 'CLOWN', name: 'Anomaly Clownfish', rarity: FishRarity.RARE, price: 0.17, supply: 10_000_000, volatility: 0.32, trend: 0.005 },
  { symbol: 'HORSE', name: 'Pixel Seahorse', rarity: FishRarity.RARE, price: 0.425, supply: 8_000_000, volatility: 0.28, trend: 0.006 },
  { symbol: 'DGUPPY', name: 'Diamond Guppy', rarity: FishRarity.RARE, price: 0.85, supply: 5_000_000, volatility: 0.25, trend: 0.008 },
  { symbol: 'PIRANA', name: 'Chaos Piranha', rarity: FishRarity.RARE, price: 1.7, supply: 4_500_000, volatility: 0.22, trend: 0.01 },
  { symbol: 'CBETTA', name: 'Cosmic Betta', rarity: FishRarity.EPIC, price: 4.25, supply: 2_000_000, volatility: 0.18, trend: 0.01 },
  { symbol: 'BARRA', name: 'Laser Barracuda', rarity: FishRarity.EPIC, price: 8.5, supply: 1_500_000, volatility: 0.15, trend: 0.008 },
  { symbol: 'QKOI', name: 'Quantum Koi', rarity: FishRarity.EPIC, price: 20.4, supply: 1_250_000, volatility: 0.12, trend: 0.012 },
  { symbol: 'ANGEL', name: 'Moon Angel', rarity: FishRarity.EPIC, price: 59.5, supply: 1_000_000, volatility: 0.1, trend: 0.01 },
  { symbol: 'AROWANA', name: 'Golden Arowana', rarity: FishRarity.LEGENDARY, price: 136, supply: 900_000, volatility: 0.08, trend: 0.015 },
  { symbol: 'EPUFFER', name: 'Emperor Puffer', rarity: FishRarity.LEGENDARY, price: 255, supply: 800_000, volatility: 0.065, trend: 0.01 },
  { symbol: 'ASHARK', name: 'Albino Shark', rarity: FishRarity.LEGENDARY, price: 476, supply: 50_000, volatility: 0.055, trend: 0.012 },
