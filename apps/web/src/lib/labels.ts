...
const ERROR_MAP: Array<[RegExp | string, string]> = [
  ...
  ['Выберите друга', 'Выберите друга или укажите @username'],
  ['Друг не найден', 'Друг не найден — он должен открыть приложение хотя бы раз'],
  ['Недостаточно кредитов для вашей половины', 'Недостаточно кредитов для вашей половины'],
  ['У друга недостаточно кредитов', 'У друга недостаточно кредитов для половины сделки'],
  ['Уже есть активное приглашение', 'Уже есть активное приглашение по этой рыбе'],
  ['Промокод не найден', 'Промокод не найден'],
  ['Промокод истёк', 'Промокод истёк'],
  ['Промокод больше не действует', 'Промокод больше не действует'],
  ['Вы уже использовали этот промокод', 'Вы уже использовали этот промокод'],
